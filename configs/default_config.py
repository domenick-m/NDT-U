...
config.wandb.project = 'analysis-sweep-test' # The wandb project the run should be stored in
...
# config.wandb.sweep.model.n_layers = [1, 2, 3, 4, 5, 6]
...
# config.wandb.sweep.model.hidden_size = [32, 64, 128]
