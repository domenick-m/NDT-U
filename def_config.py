...
config.data.overlap = 19   # Overlapping bins between chops for training
...
config.data.cl_align_range = [400, 2000]
...
config.train.val_interval = 1000 # Epochs between running on the validation set
...
config.train.ramp_start = 7500 # Epoch when the expand prob starts to increase
